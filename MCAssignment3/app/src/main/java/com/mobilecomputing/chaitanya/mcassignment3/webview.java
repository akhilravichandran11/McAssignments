    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String text1 = Arrays.deepToString(walking);

                int[][] running = {{6, 2, 5}, {0, 4, 9}, {3, 5, 9}, {6, 9, 1}, {1, 9, 2}};
                String text2 = Arrays.deepToString(running);

                int[][] eating = {{2, 2, 6}, {5, 1, 2}, {9, 9, 7}, {6, 9, 9}, {8, 4, 3}, {4, 1, 7}};
                String text3 = Arrays.deepToString(eating);

                webview.loadUrl("javascript:showGraph(" + text1 + ", " + text2 + ", " +text3 + ")");
            }
        });
