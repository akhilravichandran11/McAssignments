...
/**
 * Created by ddeepak on 2/3/2017.
 */
...
public class GraphView extends View {
    ...
    public GraphView(Context context, float[] values, float[] valuesy, float[] valuesz, String title, String[] horlabels, String[] verlabels, boolean type) {
        super(context);
        if (values == null)
            values = new float[0];
        else
